use crate::preview2::{WasiTcpView, WasiView};
...
pub fn add_to_linker<T: WasiView + WasiTcpView>(l: &mut wasmtime::component::Linker<T>) -> anyhow::Result<()> {
...
pub mod sync {
    ...
    pub fn add_to_linker<T: WasiView + WasiTcpView>(
